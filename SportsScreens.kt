...
fun SportsApp(
    ...
    when (windowSize) {
        WindowWidthSizeClass.Compact -> {
            navigationType = SportsNavigationType.BOTTOM_NAVIGATION
            contentType = SportsContentType.ListOnly
        }
        WindowWidthSizeClass.Medium -> {
            navigationType = SportsNavigationType.NAVIGATION_RAIL
            contentType = SportsContentType.ListOnly
        }
        WindowWidthSizeClass.Expanded -> {
            navigationType = SportsNavigationType.PERMANENT_NAVIGATION_DRAWER
